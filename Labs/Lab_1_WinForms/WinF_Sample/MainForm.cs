...
namespace WinF_Sample
{
    public partial class MainForm : Form
    {
        ...
        private void loadImage(bool jpg)
        {
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                try {
                    ...
                    // встановлюємо зображення в елемент PictureBox 
        ...
        {
            // створюємо змінну rsl, яка зберігатиме результат вибору користувача
            // у вікні запитання; натиснута кнопка і є результатом
            // MessageBox міститиме запитання, а також кнопки Yes, No та іконку Question (Питання)
            DialogResult rsl = MessageBox.Show(
                "Ви дійсно хочете вийти з застосунку?",
                "Увага!",
