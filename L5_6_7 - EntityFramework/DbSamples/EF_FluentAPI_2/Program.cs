...
// Альтернативний варіант застосування конфігурацій надає атрибут EntityTypeConfiguration,
// який застосовується до сутності та отримує тип класу конфігурації:
