...
Note: если Вы получите сообщение о том что update-database - это неизвестная команда,
      проверьте что для проекта установлен пакет Microsoft.EntityFrameworkCore.Tools
